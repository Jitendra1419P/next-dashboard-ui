  ...
  return (
    <div className="mx-4 px-4 pb-4 mb-8 shadow-md rounded-xl">
      ...
      <div className="p-2 mb-2 flex ">
        <div className="flex items-center justify-center font-medium text-xs px-4 py-1 border-2 border-[#0054E7] rounded-full text-[#0054E7] bg-[#d9e7ff] w-auto">
          Status : {status}
        </div>
      </div>
    </div>
...
export default PendingTicketsBlue;
