  ...
  return (
    <div className="mx-4 px-4 pb-4 mb-8 shadow-md rounded-xl">
      <div className="flex gap-2 justify-between mb-2">
        <div className="flex items-center justify-between w-1/2">
          ...
          <div className="w-[60%]">
            ...
            <p className="font-medium text-[11px] text-[#808080]">{raiser}</p>
          </div>
        </div>
      ...
      <div className="p-2 mb-2 flex ">
        <div className="flex items-center justify-center font-medium text-xs px-4 py-1 border-2 border-[#029738] rounded-full text-[#029738] bg-[#dffcea] w-auto">
          Status : {status}
        </div>
      </div>
    </div>
...
export default PendingTicketsGreen;
