  ...
  return (
    <div className="mx-4 px-4 pb-4 mb-8 shadow-md rounded-xl">
      ...
      <div className="p-2 mb-2 flex ">
        <div className="flex items-center justify-center font-medium text-xs px-4 py-1 border-2 border-[#FFBF04] rounded-full text-[#FFBF04] bg-[#fff7df] w-auto">
          Status : {status}
        </div>
      </div>
    </div>
...
export default PendingTicketsYellow;
